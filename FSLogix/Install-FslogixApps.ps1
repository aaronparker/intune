...
Switch ([intptr]::Size) {
    4 { Write-Verbose -Message "32-bit processor"; $Url = "https://stlhppymdrn.blob.core.windows.net/fslogix-agent/x86/FSLogixAppsSetup.exe" }
    8 { Write-Verbose -Message "64-bit processor"; $Url = "https://stlhppymdrn.blob.core.windows.net/fslogix-agent/x64/FSLogixAppsSetup.exe" }
}
...
If (Test-Path "$Target\$Installer") {
    ...
    If ($Agent.Version -lt $ProductVersion) {
        ...
        Show-Toast -ToastTitle "FSLogix Apps was installed." `
            -ToastText "A new application has been installed. Please save your work and restart your PC as soon as possible." -ToastDuration long;
    } Else {
