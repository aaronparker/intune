    ...
    Switch ($Operation) {
        ...
        "Whitelist" {
            ...
            ForEach ( $package in $packages) {
                $allPackages += Get-AppxPackage -Name $package.DisplayName | Select-Object PackageFamilyName
            }
            ...
            $systemApps = Get-AppxPackage | Where-Object { $_.InstallLocation -like "$env:SystemRoot\SystemApps*" -or $_.IsFramework -eq $True } | Select-Object PackageFamilyName
